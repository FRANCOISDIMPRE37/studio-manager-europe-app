...
const DOC_CATEGORIES = [
  ...
  },
  {
    ...
    icon: FileText,
    color: '#FF9800',
    docs: ['questionnaire_tatouage_majeur', 'questionnaire_dermographe', 'consentement_soins_tatouage', 'soins_dermographe', 'fiche_seance_tatouage', 'fiche_seance_dermographe'] as DocumentType[],
    forMineur: null,
  },
  {
